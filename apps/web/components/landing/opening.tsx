...
export function Opening() {
  ...
  useLayoutEffect(() => {
    ...
    mm.add("(prefers-reduced-motion: no-preference)", () => {
      ...
      failSafe = setTimeout(() => { tl.progress(1); finish() }, 2400)
    ...
    mm.add("(prefers-reduced-motion: reduce)", () => { finish() }, root)
  ...
  return (
    <div ref={rootRef} className={styles.opening}>
      ...
      <LandingNav />
      <div data-intro-cover className={styles.introCover} aria-hidden="true" />
      <section id="main-content" data-hero className={styles.hero} aria-labelledby="hero-heading" tabIndex={-1}>
        <Image src={media.hero.src} alt={media.hero.alt} fill priority sizes="100vw" placeholder="blur" className={styles.photo} />
