              ...
              <div style={{ position: "relative", height: 5, borderRadius: r.pill, background: "rgba(255,255,255,0.08)", overflow: "hidden", marginBottom: 5 }}>
                ...
                {on && !reduce && (
                  <motion.div
                    ...
                    style={{ position: "absolute", top: 0, bottom: 0, width: "40%", background: "linear-gradient(90deg, transparent, rgba(255,255,255,0.5), transparent)" }}
                  />
                )}
              </div>
  ...
  return (
    <div style={{ ...panel, padding: 0, position: "relative", overflow: "hidden", width: "100%", aspectRatio: `${MAP_VB.w} / ${MAP_VB.h}` }}>
      ...
      {!reduce && (
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: hintGone ? 0 : [0, 0.8, 0.8, 0] }}
          transition={hintGone ? { duration: 0.3 } : { delay: T.tooltip / 1000 + 0.4, duration: 4, times: [0, 0.1, 0.8, 1], repeat: hintGone ? 0 : Infinity, repeatDelay: 1 }}
      ...
      <div key={playKey} style={{ position: "relative", display: "flex", flexDirection: "column", gap: 10 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            ...
            />
            <span style={{ fontSize: 9.5, color: "rgba(255,255,255,0.4)", fontFamily: ff.body }}>live</span>
          </div>
          <button
