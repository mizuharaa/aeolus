...
const TOP: Band[] = [
  { color: "var(--accent-purple)", opacity: 0.09, midY: 60,  amp: 26, thick: 10, periods: 2, phase: 0.4, dur: 46 },
  { color: "var(--accent-blue)",   opacity: 0.07, midY: 100, amp: 34, thick: 14, periods: 1.5, phase: 2.2, dur: 60, reverse: true },
  { color: INK_WASH,               opacity: 0.05, midY: 140, amp: 22, thick: 8,  periods: 2.5, phase: 4.0, dur: 38 },
]
const BOTTOM: Band[] = [
  { color: INK_WASH,               opacity: 0.05, midY: 50,  amp: 30, thick: 12, periods: 1.5, phase: 1.1, dur: 52, reverse: true },
  { color: "var(--accent-purple)", opacity: 0.08, midY: 100, amp: 24, thick: 9,  periods: 2, phase: 3.3, dur: 44 },
  { color: "var(--accent-blue)",   opacity: 0.06, midY: 145, amp: 36, thick: 16, periods: 1, phase: 5.1, dur: 66 },
]
